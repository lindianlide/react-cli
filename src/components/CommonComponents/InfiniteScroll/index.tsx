 ...
 * @date 2020/09/23
 * @example
 * <InfiniteScroll pageStart={0} loadMore={getMore} hasMore={taskState.hasMore} loader={<div></div>}>
        <li></li>
   </InfiniteScroll>
   @params:
    children：加载的内容
    ...
    loader：加载中dom
    loadered：没有更多dom
    initialLoad：是否初始化请求接口
    loadMore：请求下一页方法，(pageNum)=>{}
    pageStart：起始页码
    threshold: 距离底部距离阈值
 */
...
export default class InfiniteScroll extends Component {
    ...
    render() {
        ...
        if (hasMore) {
            ...
            if (loadered) {
                isReverse ? childrenArray.unshift(loadered) : childrenArray.push(loadered)
            }
        }
